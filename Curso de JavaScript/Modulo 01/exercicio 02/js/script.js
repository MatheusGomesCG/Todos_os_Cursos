...
document.body.innerHTML += `O seu nome com letras maiúsculos é: ${nome.toUpperCase()}<br />`
document.body.innerHTML += `O seu nome com letras minúsculas é: ${nome.toLowerCase()}<br />`